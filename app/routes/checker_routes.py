...
def check_answer():
    ...
    try:  
        return {"success": True, "answer": calculate_cross_sums(data["row_targets"], data["col_targets"], data["row_weights"], data["col_weights"])}
    except Exception:
        return {"success": False, "errorMessage": "No answer or faulty values"}
